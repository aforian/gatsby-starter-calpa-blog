...
tags:
  - 那些前端開發應該要知道的小事
  - will-change
headerImage: ../../static/assets/will-change-banner.png
...
![Chrome devTools 的 layer panel 可以檢查目前畫面上的渲染層](../../static/assets/will-change-1.png)
...
![未加入 will-change 的渲染層](../../static/assets/will-change-2.gif)
...
![加入 will-change 的渲染層](../../static/assets/will-change-3.gif)
