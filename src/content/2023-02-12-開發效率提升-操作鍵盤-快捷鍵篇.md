---
id: ""
slug: shorcuts_and_combine_keys
...
![source: https://www.keychron.com/pages/keychron-k12-compact-wireless-60-layout-mechanical-keyboard-2](assets/shortcuts_and_combine_keys-4.png "source: https://www.keychron.com/pages/keychron-k12-compact-wireless-60-layout-mechanical-keyboard-2")
...
3. 回到 vscode ，如果想要輸入 `cmd + shift + →` 按住 `左 cmd` + `shift` （左手）和 `右 cmd` + `l` （右手）便可以實現操作
   ...
   使用 Karabiner-EventViewer 可以檢視原鍵盤輸入事件
